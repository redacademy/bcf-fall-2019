          ...
          <View style={styles.eventDetails}>
            ...
            <View style={styles.languageSection}>
              ...
              <View style={styles.languageInputField}>
                ...
                />
                <Text style={styles.languageTitle}>{tour.duration} hours</Text>
              </View>
            </View>
          </View>
          <View style={styles.eventDetails}>
            <View style={styles.difficultyFilter}>
              ...
              <View style={styles.filterSectionImages}>
                ...
                />
                <Text style={styles.tourDiffucultyTitle}>{tour.distance}</Text>
              </View>
            </View>
          ...
          <View style={styles.inputFieldStyles}>
            ...
            <TouchableOpacity>
              <Text style={styles.downloadAudio}>
                {tour.audio && tour.audio.markers.length > 1 ? 'Download' : ''}
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
              onPress={() => {
